...
const unsigned int8 jig_challenge[64] = {0};
...
const unsigned int16 usb_dongle_revoke_list[] = {0, 2, 13, 32, 34, 176, 241, 0xFFFF};

const unsigned int8 usb_dongle_master_key[20] = {0};
const unsigned int8 usb_dongle_key[20] = {
